...
public interface IWebhookService
{
  ...
  Task SendWebhookAsync(WebHookDetails webHookDetails, CancellationToken cancellationToken = default);
}
...
public class WebhookService : IWebhookService
{
  ...
  public async Task SendWebhookAsync(WebHookDetails webHookDetails, CancellationToken cancellationToken = default)
  {
